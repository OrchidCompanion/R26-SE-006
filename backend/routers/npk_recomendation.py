...
def evaluate_npk(
    ...
    if sensor_total <= 0:
        ...
        return {
            ...
            "recommendation": [
                ...
                f"No NPK sensor reading was detected (Nitrogen: 0, Phosphorus: 0, Potassium: 0).",

                f"Nutrients are marked as DEFICIENT for the {stage} growth stage.",

                f"The target fertilizer ratio for this stage is {target_ratio}.",

                "Apply recommended fertilizer program and connect NPK sensor to re-test readings."
            ],
        }
    ...
    # ========================================================
        ...
        advice.append(
            ...
            "fertilizer program toward the 20-20-20 N-P-K ratio. "
            "Add fertilizer gradually and re-test the NPK "
            "readings until the measured nutrient balance "
            "approaches this target ratio."
        )
