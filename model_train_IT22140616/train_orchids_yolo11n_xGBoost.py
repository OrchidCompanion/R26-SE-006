...
YOLO_MODEL_PATH = r'D:\R26-SE-006\model_train_IT22140616\runs\classify\orchid_yolo11n-cls-3\weights\best.pt'
...
def train_hybrid_model():
    ...
    joblib.dump(hybrid_xgb, 'orchid_hybrid_yolo11_xgb.pkl')
